...
r, o = deconvolution(measured, psf, loss=Gauss(), 
    ...
    \subsection{Influence of Regularizer}
        ...
        \begin{figure}[h]
            ...
            \begin{subfigure}[b]{.166\textwidth}
                \centering
                \includegraphics[width=\textwidth]{figures/resolution_test_chart_no_reg_iter_30.png}
                \caption{Without regularizer}
                \label{fig:fabiob}
            \end{subfigure}%
            \begin{subfigure}[b]{.166\textwidth}
                \centering
                \includegraphics[width=\textwidth]{figures/resolution_test_chart_regularizer_005_iter_30.png}
            ...
            \caption{a) has been convolved with a PSF and affected by Poisson shot noise (100 photons expected for the brightest pixel). 
                        Deconvolved b) for 50 iterations without an regularizer c) with Good's roughness regularizer and 
                            converged after 20 iterations with $\lambda=0.03$.}
            \label{fig:image}
        \end{figure}
        ...
        \autoref{fig:fabioc} shows the results after 20 iterations of the deconvolution but regularized with a Good's roughness regularizer.
        ...
        The meaning of the relative energy regain is how well certain frequencies are reconstructed in comparison
        ...
        \begin{figure}[h]
            ...
            \begin{subfigure}[b]{.23\textwidth}
                ...
                \caption{Relative energy regain $G_\textrm{R}$ over different frequencies.}
                \label{fig:rel_energy_regain}
            \end{subfigure}
            \hfill
            \begin{subfigure}[b]{.23\textwidth}
                \centering
                \includegraphics[width =0.97 \textwidth]{figures/test_chart_ncc.pdf}
                \caption{Normalized correlation coefficient (NCC) over the number of iterations.}
                \label{fig:ncc}
            \end{subfigure}
        ...
        The green curve shows the relative energy regain of the deconvolution without a regularizer. For certain regions below  $f_\textrm{max}$
        the deconvolution enhances the contrast. However, around and beyond $f_\textrm{max}$ several artifacts are introduced.
        The regularized blue curve performs much better and only certain frequencies show a relative energy regain below zero.
        ...
        \autoref{fig:ncc} shows the normalized correlation coefficient over the number of iterations.
        Especially the deconvolution without an regularizer suffers from poor performance after a high number of iterations.
        Either one has to stop early after a hand optimized iteration number or use a regularizer.
